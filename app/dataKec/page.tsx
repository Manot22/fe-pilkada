            ...
            <ul>
              <li className="bg-gray-50 p-4 mb-4 rounded-lg shadow-sm flex items-center justify-between">
                <div className="flex flex-col">
                  <p className="text-black">Nama Kecamatan</p>
                  <p className="text-gray-600">Suara Kecamatan</p>
                  <p className="text-gray-600">dapil_id</p>
                  <p className="text-gray-600">paslon_id</p>
                </div>
                <div className="flex space-x-2">
                  <Link href={`/dataKec/edit`}>
